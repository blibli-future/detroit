...
class AgentReport extends BaseDetroitComponent {
  constructor(props) {
    super(props);
    this.state = {
      individualStatistic:[],
  ...
  getAgentDiagram() {
    let component = this;
    return this.auth.apiCall('/api/v1/statistic/agent-report/diagram', {
      method: 'GET'
  ...
  getAgentInfo() {
    let component = this;
    return this.auth.apiCall('/api/v1/statistic/agent-report/info', {
      method: 'GET'
    }).then((response) => response.json())
      .then((json) => {
        component.setState({
  ...
  getAgentNote() {
    let component = this;
    return this.auth.apiCall('/api/v1/statistic/agent-report/note', {
      method: 'GET'
    }).then((response) => response.json())
      .then((json) => {
        component.setState({
  ...
  getAgentProfile() {
    let component = this;
    return this.auth.apiCall('/api/v1/users/current', {
      method: 'GET'
    }).then((response) => response.json())
      .then((json) => {
        component.setState({
